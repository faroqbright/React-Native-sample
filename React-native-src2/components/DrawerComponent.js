            ...
            <ScrollView
                ...
                <View style={{ width: '100%', height: '100%', flexDirection: 'row' }}>
                    <View style={styles.drawerContainer}>
                        ...
                        />
                        <DrawerItem
                            title={strings('drawer_components.my_profile')}
                        ...
                        />
                        <DrawerItem
                            title={strings('drawer_components.completed_jobs')}
                            imageSource={icons.drawerComplete}
                            titleStyle={styles.textHeading}
                            onPress={() => {
                        ...
                        /> */}
                        <DrawerItem
                            title={strings('drawer_components.tell_a_friend')}
                        ...
                        />
                        <DrawerItem
                            title={strings('drawer_components.my_account')}
                            imageSource={icons.drawerTerms}
                            titleStyle={styles.textHeading}
                            onPress={() => {
